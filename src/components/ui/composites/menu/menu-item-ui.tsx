...
export class MenuItemUI<P extends DefaultProps, S = DefaultState> extends Component<P, S> {
  ...
  `);
    ...
    override connectedCallback(): void {
        ...
        this.registerEvent(this, EventTypes.MouseDown, (e: Event) => this.handleOnSelect(e));

        this.registerEvent(this, EventTypes.KeyDown, (e: Event) => {
            const ke = e as KeyboardEvent;
            if (ke.key === KeyboardKeys.Enter) {
                ke.preventDefault();
