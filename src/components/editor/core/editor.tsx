...
import primitives from "@design-system/primitives.css?inline.css";
import foundation from "@design-system/foundation.css?inline.css";

import { ParagraphTrigger } from "../triggers/paragraph-trigger.tsx";
...
export class Editor extends Component {
    ...
    override onMount(): void {
        ...
        if (this.editorContent) {
            this.registerEvent(this.editorContent, EventTypes.KeyDown, this.handleEditorKeyDown as EventListener, true);
        }
        if (this.editorContent) {
