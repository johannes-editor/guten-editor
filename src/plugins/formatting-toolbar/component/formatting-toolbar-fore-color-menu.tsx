...
import { TEXT_COLOR_OPTIONS, normalizeColorValue, type ColorOption } from "./color-options.ts";

interface FormattingToolbarForeColorMenuProps extends MenuUIProps {
    anchor?: HTMLElement;
}
...
export class FormattingToolbarForeColorMenu extends MenuUI<FormattingToolbarForeColorMenuProps, FormattingToolbarForeColorMenuState> {
