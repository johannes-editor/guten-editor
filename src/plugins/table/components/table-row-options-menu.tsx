    ...
    override render() {
        return (
            <div class="guten-menu">
                <ul>
                    <li>
                        <TableRowOptionsItem table={this.props.table} rowIndex={this.props.rowIndex} targetRow={this.props.targetRow} icon={<RowPlusTopIcon />} label="Add row above" command="table.addRowAbove" />
                    </li>
                    <li>
                        <TableRowOptionsItem table={this.props.table} rowIndex={this.props.rowIndex} targetRow={this.props.targetRow} icon={<RowPlusBottomIcon />} label="Add row below" command="table.addRowBelow" />
                    </li>
                    <li>
