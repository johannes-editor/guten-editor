...
export function jsx(type: JSXType, props: JSXProps, key?: string) {
    return createElement(type, props, key);
}

export function jsxs(type: JSXType, props: JSXProps, key?: string) {
    return createElement(type, props, key);
}

export function jsxDEV(type: JSXType, props: JSXProps, key?: string) {
    return createElement(type, props, key);
}
